...
@section('title', trans('common.edit') . ' ' . trans_choice('languages.languages', 1))
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('common.edit') . ' ' . trans_choice('languages.languages', 1) }}
                </div>
                    ...
                    {!! \Form::open([
                        ...
                        <div class="form-group">
                            <div class="input-group{{ $errors->has('iso_code') ? ' has-error' : '' }}">
                                ...
                                {!! \Form::text('iso_code', old('iso_code') ?: $language->iso_code, [
                                    'class' => 'form-control',
                        ...
                        <div class="form-group">
                            <div class="input-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                ...
                                {!! \Form::text('name', old('name') ?: $language->name, [
                                    'class' => 'form-control',
                        ...
                        <div class="form-group">
                            <div class="input-group{{ $errors->has('script') ? ' has-error' : '' }}">
                                ...
                                {!! \Form::text('script', old('script') ?: $language->script, [
                                    'class' => 'form-control',
