...
@section('title', trans('common.create') . ' ' . trans_choice('currencies.currencies', 1))
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('common.create') . ' ' . trans_choice('currencies.currencies', 1) }}
                </div>

                <div class="panel-body">

                    {!! \Form::open([
                        'url' => url(trans('routes.admin') . '/' . trans('routes.currencies')),
                        'method' => 'post'
                    ]) !!}
                        ...
                        <div class="form-group">
                            <div class="input-group{{ $errors->has('decimal_precision') ? ' has-error' : '' }}">
                                ...
                                {!! \Form::text('decimal_precision', old('decimal_precision'), [
                                    'class' => 'form-control',
                        ...
                        <div class="form-group">
                            <div class="input-group{{ $errors->has('exchange_rate') ? ' has-error' : '' }}">
                                ...
                                {!! \Form::text('exchange_rate', old('exchange_rate'), [
                                    'class' => 'form-control',
