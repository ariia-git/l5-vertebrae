...
class CountriesTableSeeder extends AbstractSeeder
{
    ...
    protected $itemList = [
        ...
        ['iso_code' => 'AX', 'name' => 'Åland Islands'],
        ...
        ['iso_code' => 'BQ', 'name' => 'Bonaire, Sint Eustatius and Saba'],
        ...
        ['iso_code' => 'CD', 'name' => 'Congo, The Democratic Republic of the'],
        ...
        ['iso_code' => 'FK', 'name' => 'Falkland Islands (Malvinas)'],
        ...
        ['iso_code' => 'IR', 'name' => 'Iran, Islamic Republic of'],
        ...
        ['iso_code' => 'KP', 'name' => 'Korea, Democratic People\'s Republic of'],
        ['iso_code' => 'KR', 'name' => 'Korea, Republic of'],
        ['iso_code' => 'KW', 'name' => 'Kuwait'],
        ['iso_code' => 'KG', 'name' => 'Kyrgyzstan'],
        ['iso_code' => 'LA', 'name' => 'Lao People\'s Democratic Republic'],
        ...
        ['iso_code' => 'MK', 'name' => 'Macedonia, Republic of'],
        ...
        ['iso_code' => 'FM', 'name' => 'Micronesia, Federated States of'],
        ...
        ['iso_code' => 'PS', 'name' => 'Palestine, State of'],
        ...
        ['iso_code' => 'RE', 'name' => 'Réunion'],
        ['iso_code' => 'RO', 'name' => 'Romania'],
        ['iso_code' => 'RU', 'name' => 'Russian Federation'],
        ['iso_code' => 'RW', 'name' => 'Rwanda'],
        ['iso_code' => 'BL', 'name' => 'Saint Barthélemy'],
        ['iso_code' => 'SH', 'name' => 'Saint Helena, Ascension and Tristan da Cunha'],
        ...
        ['iso_code' => 'ST', 'name' => 'São Tomé and Príncipe'],
        ...
        ['iso_code' => 'VN', 'name' => 'Vietnam, Socialist Republic of'],
        ['iso_code' => 'VG', 'name' => 'Virgin Islands, British'],
        ['iso_code' => 'VI', 'name' => 'Virgin Islands, U.S.'],
